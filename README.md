...
| Role | Key Skills |
|------|------------|
| ☁️ Azure Data Engineer Intern | ADF · Synapse Analytics · ADLS Gen2 · Databricks |
| 📊 Analytics Engineer Intern | SQL · Data Modeling · ELT · Delta Lake |
| 🛠️ Data Engineer Intern | ETL Pipelines · PySpark · Python · Azure |
| ☁️ Cloud Data / Platform Intern | Azure · Medallion Architecture · Docker |
...
**letstalk-avii/letstalk-avii** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
